                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <i
                              className="mdi mdi-treasure-chest"
                          ...
                          <div>
                            ...
                            >
                              Current value of all products in stock (price ×
                              quantity)
                            </p>
                          </div>
                        </div>
                          ...
                          {stats?.recentBills?.length === 0 ? (
                            ...
                            stats?.recentBills?.map((bill) => (
                              <tr key={bill._id}>
                                ...
                                <td>
                                  <span
                                    className={`warm-badge ${bill.paymentMethod === "cash" ? "badge-cash" : bill.paymentMethod === "card" ? "badge-card" : "badge-online"}`}
                                  >
                                    {bill.paymentMethod || "—"}
                                  </span>
                                </td>
                            ...
                            {stats?.lowStockProducts?.length === 0 ? (
                              ...
                              stats?.lowStockProducts?.map((p) => (
                                <tr key={p._id}>
                                  ...
                                  <td>
                                    <span
                                      className={`warm-badge ${p.stockQuantity === 0 ? "badge-danger" : p.stockQuantity <= 3 ? "badge-warn" : "badge-info"}`}
                                    >
